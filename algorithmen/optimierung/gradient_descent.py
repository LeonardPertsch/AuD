...
Minimiert eine mehrdimensionale Funktion g: Der Gradient wird numerisch
über den zentralen Differenzenquotienten geschätzt und x entgegen der
Gradientenrichtung aktualisiert (Lernrate n).
"""
