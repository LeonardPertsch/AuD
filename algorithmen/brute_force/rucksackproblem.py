"""
Brute Force: Rucksackproblem
============================

Probiert alle Teilmengen der Items aus (Potenzmenge) und behält die
wertvollste Kombination, die ins Gewichtslimit passt. Garantiert optimal.
