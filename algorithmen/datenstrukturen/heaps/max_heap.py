"""
Max-Heap: Aufbau per Heapify
============================

Wandelt ein Array in einen Max-Heap um. heapify läuft von den letzten
Elternknoten (Index n//2 - 1) rückwärts bis zur Wurzel.

Laufzeit: O(n) für den Heap-Aufbau
"""
