"""
Zyklensuche per DFS (visited-Dictionary)
========================================

Startet von jedem Knoten eine Tiefensuche; trifft die DFS auf einen
bereits besuchten Knoten, gilt ein Zyklus als gefunden.
"""
