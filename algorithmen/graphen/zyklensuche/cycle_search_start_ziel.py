"""
Zyklensuche: liegen Start und Ziel im selben Zyklus?
====================================================

Sammelt per DFS mit Backtracking alle Zyklen und prüft anschließend,
ob Start- und Zielknoten gemeinsam in einem Zyklus vorkommen.
"""
