"""
Übung 14: Partikelmethoden (Animation)
======================================

Simuliert und animiert die Bewegung von Partikeln mit matplotlib.
Fallback-Script, falls der Code im Übungs-Notebook nicht läuft.
